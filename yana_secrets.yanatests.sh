...
function YANAtest:secrets {
	_yana_initialize_encryption || throw 'Failed to initialize encryption.'
	...
	_encrypted_string=$(_yana_encrypt_string "$_test_string") || throw 'Failed to encrypt string.'
	...
	_decrypted_string=$(_yana_decrypt_string "$_encrypted_string") ||
	...
	_encrypted_string_2=$(_yana_encrypt_string "$_test_string") || throw 'Failed to encrypt string.'
	...
	_decrypted_string=$(_yana_decrypt_string "$_encrypted_string_2") ||
		throw 'Failed to decrypt string.'
	[[ $_decrypted_string == "$_test_string" ]] || throw "Decrypted string should match original. Expected: '$_test_string', got: '$_decrypted_string'"

	_decrypted_string=$(
		_yana_decrypt_string \
			"hello $_encrypted_string ${_encrypted_string}_${_encrypted_string} <yanasecret:0102030405060708091a1b1c1d1e1f0102030405060708091a1b1c1d1e10102030405060708091a1b1c1d1e1f0102030405060708091a1b1c1d1e10102030405060708091a1b1c1d1e1f0102030405060708091a1b1c1d1e1fqwerty>"
	) || throw 'Failed to decrypt string.'
	[[ $_decrypted_string == "hello ${_test_string} ${_test_string}_${_test_string} <yanasecret:0102030405060708091a1b1c1d1e1f0102030405060708091a1b1c1d1e10102030405060708091a1b1c1d1e1f0102030405060708091a1b1c1d1e10102030405060708091a1b1c1d1e1f0102030405060708091a1b1c1d1e1fqwerty>" ]] ||
		throw "Decrypted string should match original. Got: '$_decrypted_string'"
	_yana_cleanup_encryption || throw 'Failed to cleanup encryption.'
}
